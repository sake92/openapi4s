...
/** Compiles generated tupson Scala 3 sources with scala-cli (and tupson on the classpath) to make sure named tuples,
  * literal unions, union types and maps typecheck.
  */
